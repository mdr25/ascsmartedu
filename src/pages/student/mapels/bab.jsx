...
const BabIndex = () => {
  ...
  try {
    ...
    // Urutkan berdasarkan angka setelah "Bab" (jika ada)
  ...
  const handleCreate = async () => {
    ...
    try {
      ...
      console.error("Gagal menambahkan bab:", err.response?.data || err.message);
  ...
  return (
    <div className="p-6">
      ...
      <nav className="flex items-center text-sm text-gray-500 mb-4 space-x-2">
        ...
        <span>&gt;</span>
        <button onClick={() => navigate(`/admin/classes/${classId}/mapel`)} className="text-teal-700 hover:underline">
          Mata Pelajaran
        </button>
        <span>&gt;</span>
            ...
            <ul className="space-y-2">
              {babs.map((bab) => (
                ...
                >
                  <span
                    onClick={() =>
                      navigate(`/admin/classes/${classId}/mapel/${lessonId}/bab/${bab.id}/subbab`)
                    }
                  ...
                  <div className="relative">
                    <button
                      onClick={() =>
                        setActiveDropdownBabId((prev) => (prev === bab.id ? null : bab.id))
                      }
