...
export const getSubbabByBabId = async (babId) => {
  try {
    const res = await api.get("/admin/subbab", {
      params: { bab_id: babId },
    });
...
export const getSubbabDetail = async (id) => {
  try {
    const res = await api.get(`/admin/subbab/${id}`);
    return res.data;
  } catch (error) {
    console.error(
...
export const createSubbab = async (data) => {
  try {
    const res = await api.post("/admin/subbab", data);
    return res.data;
  } catch (error) {
    console.error(
...
export const updateSubbab = async (id, data) => {
  try {
    const res = await api.put(`/admin/subbab/${id}`, data);
    return res.data;
  } catch (error) {
    console.error(
...
export const deleteSubbab = async (id) => {
  try {
    const res = await api.delete(`/admin/subbab/${id}`);
    return res.data;
  } catch (error) {
    console.error(
