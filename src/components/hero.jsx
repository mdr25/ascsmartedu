export default function Hero() {
  return (
    <section className="bg-white px-4 py-10 flex flex-col-reverse md:flex-row items-center justify-between max-w-7xl mx-auto gap-8">
      {/* Text Content */}
      <div className="max-w-xl space-y-6 text-center md:text-left">
        <h2 className="text-4xl md:text-5xl font-extrabold text-black font-montserrat leading-tight">
          LEARN TODAY<br />SHINE TOMORROW
        </h2>
        <p className="text-lg md:text-2xl text-black font-light font-montserrat">
